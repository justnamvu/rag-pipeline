...
2. **Ingestion Service:**
    ...
    - Handle all the messy pre-processing work: Clean special characters, normalize whitespace, and produce a clean array of text chunks as output
...
- Schema between FastAPI and Vector DB finalized before coding begins
...
│ └── components/
│ ├── UploadPanel.jsx   # Drag-and-drop upload, skeleton, doc list
│ └── ChatInterface.jsx # Message list, input bar, sources, retry
```
...
| Stage | Time | Bound by |
| - | - | - |
| parse | 0 ms | UTF-8/Latin-1 decode (instant) |
| clean | 0.2 ms | CPU |
| chunk | 0 ms | CPU |
